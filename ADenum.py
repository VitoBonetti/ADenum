...
class LdapEnum:
    ...
    def __SearchServerLdap(self, OBJECT_TO_SEARCH: str, ATTRIBUTES_TO_SEARCH: str) -> list:
            ...
            try:
                ...
                while True:
                    ...
                    msgid = self.ldapCon.search_ext_s(self.baseDn, ldap.SCOPE_SUBTREE, OBJECT_TO_SEARCH, ATTRIBUTES_TO_SEARCH, 0, serverctrls=server_controls, clientctrls='none', -1, 100)
                ...
                log.error("OPERATIONS_ERROR: " + str(error))
                exit(0)
            except ldap.LDAPError as error:
                log.error("LDAPError: " + str(error))
                exit(0)
    ...
    def SearchServerLdapUser(self, OBJECT_TO_SEARCH: str) -> list:
        ...
        try:
            ...
            while True:
                msgid = self.ldapCon.search_ext_s(self.baseDn, ldap.SCOPE_SUBTREE, OBJECT_TO_SEARCH, ATTRIBUTES_TO_SEARCH, 0, serverctrls=server_controls, clientctrls='none', timeout=-1, sizelimit=100)
                _, result_data, _, serverctrls = self.ldapCon.result3(msgid)
